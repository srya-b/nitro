...
def plot_multiple_line_histogram(base_filenames, save_path, data_type, bin_width):
    ...
    for fn in base_filenames:
        file_path = f"/home/admin/surya/parallel-data/concurrent-100000-opcode,code/{fn}.csv"
        bins = []
        counts = []
...
if __name__ == "__main__":
    ...
    if mode == "multiple-line":
        ...
        save_path = '/home/admin/surya/parallel-data/concurrent-100000-opcode,code/' + sys.argv[2]
